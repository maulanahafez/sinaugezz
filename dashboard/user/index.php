    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="./tambahuser.php" method="POST" name="adduser">
            <div class="mb-3">
    ...
    <table class="table text-center table-striped table-hover">
      ...
      ?>
        <tr>
          ...
          <td><?= $row['nama_user'] ?></td>
          <td>
            <a href="./edituser.php?id=<?= $row['username'] ?>" class="btn btn-success btn-sm">Edit</a>
            <a href="./hapususer.php?id=<?= $row['username'] ?>" class="btn btn-danger btn-sm">Delete</a>
          </td>
        </tr>
      <?php
        $i++;
